...
<div style="font-size:18px; color:#176b2c; margin-top:-15px; margin-bottom:25px; font-weight:bold;">
  by Santosh Shanmugam
<div>
...
<div class="stats-container" style="margin-top: 35px; margin-bottom: 15px;">
...
<div style="font-size:14px; color:#176b2c; margin-bottom:30px;">
Sleep is estimated only from hours the tracker actually recorded. Missing hours are ignored.
Quiet hours count as sleep only when they are part of a longer quiet block.
</div>
